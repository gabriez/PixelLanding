...
export const BrandsTrust = () => {
  return (
    <section className="radial-background w-full relative py-24 px-7">
      ...
      <h2 className="text-center text-3xl lg:text-4xl 2xl:text-5xl font-semibold text-white font-(--plus-jakarta-sans)">
        Marcas que <span className="text-gradient">confían</span> en nosotros
      </h2>
      <p className="text-center text-(--muted-foreground) text-base lg:text-lg 2xl:text-2xl font-medium w-fit md:max-w-4xl block mx-auto mt-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8 sm:px-[10%]">
